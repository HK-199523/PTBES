...
#     countrycode = models.CharField(db_column='CountryCode', max_length=4, blank=False, null=False, primary_key=True)  # Field name made lowercase.
...
#     creationdate = models.DateTimeField(db_column='CreationDate', blank=True, null=True)  # Field name made lowercase.
#     updatedate = models.DateTimeField(db_column='UpdateDate', blank=True, null=True)  # Field name made lowercase.
#     countrycode = models.CharField(db_column='CountryCode', max_length=4, blank=False, null=False)  # Field name made lowercase.
#     unitcode = models.CharField(db_column='UnitCode', max_length=100, blank=False, null=False)  # Field name made lowercase.
...
#         unique_together = (('countrycode', 'unitcode'),)



class News(models.Model):
    creationdate = models.DateTimeField()  # Field name made lowercase.
    updatedate = models.DateTimeField()  # Field name made lowercase.
    title = models.CharField(max_length=100)  # Field name made lowercase.
...
#     creationdate = models.DateTimeField(db_column='CreationDate', blank=True, null=True)  # Field name made lowercase.
#     updatedate = models.DateTimeField(db_column='UpdateDate', blank=True, null=True)  # Field name made lowercase.
#     regioncode = models.CharField(db_column='RegionCode', max_length=4, blank=False, null=False, primary_key=True)  # Field name made lowercase.
...
#     touristspotcode = models.CharField(db_column='TouristSpotCode', max_length=4, blank=False, null=False)  # Field name made lowercase.
...
#         unique_together = (('countrycode', 'touristspotcode'),)

# class Unit(models.Model):
#     creationdate = models.DateTimeField(db_column='CreationDate', blank=True, null=True)  # Field name made lowercase.
#     updatedate = models.DateTimeField(db_column='UpdateDate', blank=True, null=True)  # Field name made lowercase.
#     unitcode = models.CharField(db_column='UnitCode', max_length=100, blank=False, null=False, primary_key=True)  # Field name made lowercase.
...
class User(models.Model):
    creationdate = models.DateTimeField(db_column='CreationDate', blank=True, null=True)  # Field name made lowercase.
    updatedate = models.DateTimeField(db_column='UpdateDate', blank=True, null=True)  # Field name made lowercase.
    userid = models.IntegerField(db_column='UserID', blank=False, null=False, primary_key=True)  # Field name made lowercase.
